...
public class PacoteSportTableDisplay implements Initializable {
    ...
    public void loadItems() {
        ...
        itens.getItems().addAll(this.mc.getSporPac().getItens());
    }
    ...
    public void loadDetalhesInteriores() {
        ...
        detInt.getItems().addAll(this.mc.getSporPac().getDetsInterior());
    }
    ...
    public void loadDetalhesExteriores() {
        ...
        detsExt.getItems().addAll(this.mc.getSporPac().getDetsExterior());
    }
